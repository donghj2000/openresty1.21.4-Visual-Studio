...
EXE_LIBRARY_API int ngx_stream_lua_ffi_sema_new(ngx_stream_lua_sema_t **psem,
    int n, char **errmsg);
EXE_LIBRARY_API int ngx_stream_lua_ffi_sema_post(ngx_stream_lua_sema_t *sem, int n);
EXE_LIBRARY_API int ngx_stream_lua_ffi_sema_wait(ngx_stream_lua_request_t *r,
...
EXE_LIBRARY_API void ngx_stream_lua_ffi_sema_gc(ngx_stream_lua_sema_t *sem);
